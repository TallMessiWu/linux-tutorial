...
| 区域 | 定位标记 | 约行号 |
|------|----------|--------|
| 内联 CSS(深色终端主题、变量在 `:root`) | `<style>` … `</style>` | 7–194 |
...
|----|----|------|--------|
| 1 | `c1` | 如何用这份教程 | 241 |
| 2 | `c2` | 文件与目录基础(含 ls 参数、**tree**、glob 通配符) | 299 |
| 3 ★ | `c3` | 管道与重定向 | 423 |
| 4 ★ | `c4` | grep 与正则 | 526 |
| 5 | `c5` | 文本三剑客与切分工具(cut/sort/uniq/sed/awk) | 616 |
| 6 ★ | `c6` | find 实战 | 665 |
| 7 | `c7` | 权限·进程·信号·磁盘(含 chmod/chown 归属、kill 信号、作业控制 `&`/`fg`) | 741 |
| 8 ★ | `c8` | 远程传输与打包(scp/rsync/curl/wget/tar,详见 c18) | 908 |
| 9 | `c9` | 会话保持与 Shell 效率(tmux 三层模型、history/Ctrl-R) | 983 |
| 10 | `c10` | SSH 进阶(config/免密/端口转发/跳板机) | 1078 |
| 11 | `c11` | 服务·日志·定时(systemctl/journalctl/crontab) | 1125 |
| 12 | `c12` | 排查类工具(ss/lsof/jq/watch/du) | 1165 |
| 13 ★ | `c13` | echo·变量·环境(`echo "..." >>`、引号、export、PATH) | 1203 |
| 14 ★ | `c14` | 组合命令实战配方 | 1277 |
